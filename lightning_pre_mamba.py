...
parser.add_argument('--hydra_ckpt', type=str, default='hydra_ckpt/bert-base-uncased.bin')
...
def main():
    ...
    config = RecmambaConfig.from_pretrained(args.model_name_or_path, **hydra_config_params)
